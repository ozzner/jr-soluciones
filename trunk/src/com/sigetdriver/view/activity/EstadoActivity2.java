...
public class EstadoActivity2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lista.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {		
            ...
            public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
            	...
            	Intent i = new Intent(EstadoActivity2.this, ServicioActivity.class);
            	startActivity(i);
                return false;
            }
        });
...
//				    	 System.out.println("Funciono!");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case CERRAR_SESION:	
			...
			Intent i = new Intent(EstadoActivity2.this, LoginActivity.class);
			startActivity(i);
			finish();
			break;
	...
	public void onBackPressed() {
		...
		stopService(new Intent(EstadoActivity2.this, TrackingService.class));
		finish();
	}
