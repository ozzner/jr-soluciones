	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lista.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {		
            ...
            public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
            	...
            	Intent i = new Intent(NotificacionesActivity.this, ServicioActivity.class);
            	startActivity(i);
                return false;
            }
        });
...
//				    	 System.out.println("Funciono!");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case CERRAR_SESION:	
			...
			Intent i = new Intent(NotificacionesActivity.this, LoginActivity.class);
			startActivity(i);
			finish();
			break;
	...
	public void onBackPressed() {
		...
		stopService(new Intent(NotificacionesActivity.this, TrackingService.class));
		finish();
	}
